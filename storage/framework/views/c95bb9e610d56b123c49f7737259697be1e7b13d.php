...
<body>
    <section id="dashborad" class="flex">
        ...
        <section id="dashboard-anggotaForm" class="w-full">
            ...
            <form method="post" action="<?php echo e(url("/anggota")); ?>" class="w-full">
...
</html><?php /**PATH D:\User\Documents\Code\Laravel\latihan1\resources\views/dashboard/anggota/inputAnggota.blade.php ENDPATH**/ ?>