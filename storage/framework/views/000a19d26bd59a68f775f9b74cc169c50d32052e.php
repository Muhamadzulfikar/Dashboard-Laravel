...
<body>
    <section id="dashborad" class="flex">
        ...
        <section id="dashboard-anggotaForm" class="w-full">
            ...
            <form method="post" class="w-full" action="<?php echo e(url("/anggota", $members->id)); ?>">
                ...
                <section class="dashboard-field ">
                    ...
                    <div class="field-container mt-10 lg:mt-16">
                        ...
                        <input type="text" name="nama" value="<?php echo e($members->name); ?>">
                    </div>

                    <div class="field-container">
                        <label for="tempatlahir">Tempat Lahir</label>
                        <input type="text" name="tempatlahir" value="<?php echo e($members->placeOfBirth); ?>">
                    </div>

                    <div class="field-container">
                        <label for="tanggallahir">Tanggal Lahir</label>
                        <input type="text" name="tanggallahir" value="<?php echo e($members->dateOfBirth); ?>">
                    </div>

                    <div class="field-container">
                        <label for="Alamat">Alamat</label>
                        <input type="text" name="alamat" value="<?php echo e($members->address); ?>">
                    </div>

                    <div class="field-container">
                        <label for="jenis kelamin">Jenis Kelamin</label>
                        <input type="text" name="jeniskelamin" value="<?php echo e($members->gender); ?>">
                    </div>

                    <div class="field-container">
                        <label for="tempatlahir">Telepon</label>
                        <input type="text" name="telepon" value="<?php echo e($members->phone); ?>">
                    </div>
...
</html><?php /**PATH D:\User\Documents\Code\Laravel\latihan1\resources\views/dashboard/anggota/editAnggota.blade.php ENDPATH**/ ?>