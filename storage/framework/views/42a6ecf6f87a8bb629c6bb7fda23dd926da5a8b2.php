...
<body>
    ...
    <section class="flex">
        ...
        <aside id="aside"
            ...
            <a class="aside-list aside-list-active" href="<?php echo e(url('/')); ?>">
                ...
                <div class='lg:flex w-full justify-between'>
                    ...
                    <div class='lg:w-3/4 w-full mr-7'>
                        ...
                        <div class='w-full bg-white mt-5 rounded-2xl p-7 text-gray-700'>
                            <h1 class='font-bold uppercase'>JADWAL KULIAH HARI INI (<?php echo e(date('l, d F Y')); ?>)</h1>
                            <?php if(date('N') != 6 && date('N') != 7): ?>

                            <!-- Roster Content Start -->
                            <?php $__currentLoopData = $roaster; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class='mt-5 ml-7 mb-8'>

                                <!-- Roaster Time Start -->
                                <div class='flex text-gray-500'>
                                    <p class='font-bold text-lg'><?php echo e($data -> time); ?></p>
                                ...
                                <h1 class='font-bold text-lg text-gray-700 mt-2'><?php echo e($data -> name); ?></h1>
                                <p class='text-gray-500 mt-4'><?php echo e($data -> major); ?> (<?php echo e($data ->semester); ?> <?php echo e($data->class); ?>)
                                </p>
                                ...
                                <div class='flex items-center mt-4'>
                                    ...
                                    <p class='mx-2'><?php echo e($data -> room); ?> |</p>
                        ...
                        <div class='w-full bg-white h-72 rounded-2xl p-5'>
                            ...
                            <div class='flex items-center justify-between'>
                                <div class='flex items-center'>
                                    ...
                                    <?php $test=0; ?>
                                    <?php $__currentLoopData = $notification; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php $test = $data -> id ?>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <div class='h-5 bg-green-400 w-5 rounded-2xl ml-1 text-center text-white text-sm'><?php echo e($test); ?></div>
                                </div>
                                <div
                                    class='h-5 p-1 flex justify-center items-center bg-blue-500 text-white text-xs rounded font-bold'>
                                    VIEW ALL</div>
                            ...
                            <div class='overflow-auto h-52 p-2 mt-2'>
                                ...
                                <div class='mb-5 text-gray-600'>
                                    <h1 class='text-lg font-medium mb-2'><?php echo e($data -> Notification_title); ?></h1>
                                    <p class='text-sm font-medium text-gray-500'><?php echo e($data -> Notification_time); ?></p>
                                </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
...
</html><?php /**PATH D:\User\Documents\Code\Laravel\latihan1\resources\views/dashboard/index.blade.php ENDPATH**/ ?>