...
<body>
    <section id="dashborad" class="flex">
        ...
        <section id="dashboard-anggotaForm" class="w-full">
            ...
            <form method="post" class="w-full" action="{{ url("/anggota", $members->id) }}">
                {{ csrf_field() }}
                {{ method_field('PUT') }}
                <section class="dashboard-field ">
                    ...
                    <div class="field-container mt-10 lg:mt-16">
                        ...
                        <input type="text" name="nama" value="{{$members->name}}">
                    </div>

                    <div class="field-container">
                        <label for="tempatlahir">Tempat Lahir</label>
                        <input type="text" name="tempatlahir" value="{{$members->placeOfBirth}}">
                    </div>

                    <div class="field-container">
                        <label for="tanggallahir">Tanggal Lahir</label>
                        <input type="text" name="tanggallahir" value="{{$members->dateOfBirth}}">
                    </div>

                    <div class="field-container">
                        <label for="Alamat">Alamat</label>
                        <input type="text" name="alamat" value="{{$members->address}}">
                    </div>

                    <div class="field-container">
                        <label for="jenis kelamin">Jenis Kelamin</label>
                        <input type="text" name="jeniskelamin" value="{{$members->gender}}">
                    </div>

                    <div class="field-container">
                        <label for="tempatlahir">Telepon</label>
                        <input type="text" name="telepon" value="{{$members->phone}}">
                    </div>
